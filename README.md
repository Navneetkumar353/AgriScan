...
| Feature | Description |
|----------|-------------|
| **Disease Detection** | Uses pretrained YOLOv8s classifier trained on the [PlantDoc Dataset] |
...
- **Dataset Name:** [PlantDoc Dataset](https://www.kaggle.com/datasets/abdulhasibuddin/plant-doc-dataset)
- **Size:** ~938 MB (Approx.)
- **Structure:**  
